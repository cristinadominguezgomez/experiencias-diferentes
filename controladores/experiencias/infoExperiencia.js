...
const infoExperiencia = async (req, res, next) => {
  ...
  try {
    ...
    const [result] = await connection.query(`
        ...
        SELECT experiencia.id, experiencia.titulo, experiencia.descripcion, experiencia.localidad, experiencia.n_plazas, experiencia.f_inicio, experiencia.f_fin, experiencia.precio, 
